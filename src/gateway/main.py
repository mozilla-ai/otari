...
_QUICKSTART_URL = "https://github.com/mozilla-ai/otari/blob/main/docs/quickstart.md"
...
<html lang="en">
  <head>
    ...
    <title>Otari (Proxy Server)</title>
    <style>
      :root {
        --brand: #4e8295;
        --brand-dark: #3c6678;
  ...
  <body>
    <header class="nav">
      <span class="brand" aria-label="Otari">
        <svg viewBox="0 0 882 250" role="img" aria-hidden="true" fill="#4e8295" xmlns="http://www.w3.org/2000/svg">
    ...
    <main>
      <section class="hero">
        <span class="kicker"><span class="status-dot"></span>Otari (Proxy Server)</span>
        <h1>Your gateway is running.</h1>
        <p class="lede">
          One OpenAI-compatible endpoint in front of 40+ providers, with API key management,
          budget enforcement, and usage tracking. Point any OpenAI client at it and make your first request.
        </p>
        <div class="cta-row">
...
""".replace("QUICKSTART_URL", _QUICKSTART_URL)
