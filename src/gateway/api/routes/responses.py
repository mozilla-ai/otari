...
async def create_response(
    ...
    # downstream, so surface a clearer 400 upfront. In connected mode validate
    ...
    # for analytics; connected mode handles attribution server-side via the
    # correlation id.
    if not ctx.connected_mode and ctx.user_id:
