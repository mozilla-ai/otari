...
Revises: a7d3f5b1c9e4
Create Date: 2026-08-19 00:00:00.000000

Rebased twice, not onto the original ``a3c7e1b9d5f2``: first onto
``c8f2a6b4e9d3``, the merge that landed on main while this one was in flight
and rejoined the two branches ``a3c7e1b9d5f2`` had forked into; then onto
``a7d3f5b1c9e4`` (organization model pricing), which landed on main chained
onto that same ``c8f2a6b4e9d3`` while this one was still in flight a second
time. Chaining directly onto whichever revision is actually at main's head,
rather than adding another merge revision each time, keeps the graph at one
head with no redundant no-op revisions.
...
down_revision: str | Sequence[str] | None = "a7d3f5b1c9e4"
