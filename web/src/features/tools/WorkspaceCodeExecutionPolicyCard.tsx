  ...
  return (
    ...
    >
      ...
      <SettingRow
        ...
        help="For requests billed here that declare a provider's own code tool. A pin here overrides the deployment default and refuses a request header that disagrees."
