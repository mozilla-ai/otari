...
3. Only the Unit of Work calls `commit()` or `rollback()`, and only a repository imports `session_for`. The [backend standards](.github/skills/backend-standards/SKILL.md#who-commits) say how it is used.
