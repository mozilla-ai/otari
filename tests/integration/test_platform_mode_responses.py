"""Platform-mode integration tests for /v1/responses.

Mirror of :mod:`tests.integration.test_platform_mode_messages` for the OpenAI
...
def test_platform_mode_provider_without_responses_support_returns_400(
    platform_client: TestClient,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
