...
- [Deployment](deployment.md) — connected mode, optional services, and deployment-specific configuration.
...
- [Connected-mode protocol](connected-mode-protocol.md) — Otari/platform wire contract, for platform builders.
