...
- [Agent Gates](agent-gates.md): repo-owned policy checks on what a coding agent's
  session actually did, served by Otari's Hook Server at `POST /api/v1/hooks/check`.
