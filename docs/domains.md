...
- Services: `_tool_loop.py`, `builtin_tool.py`, `builtin_tool_registry.py`,
  `web_search_tool.py`, `code_execution_tool.py`, `mcp_loop.py`,
  `mcp_loop_messages.py`, `mcp_loop_responses.py`, `mcp_client.py`,
  `mcp_stateless.py`, `sandbox_backend.py`, `search_backend.py`,
  `web_search_backend.py`, `web_search_budget.py`, `web_search_providers.py`,
  `web_extraction.py`, `web_fetch_service.py`, `web_retrieval_backend.py`,
